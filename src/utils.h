...
namespace SCREEN
{
    static constexpr const QSize LOGICAL_SIZE  = QSize(512, 384);
    static constexpr const QSize CELL_SIZE     = QSize(2  , 2  );
...
{
    static const QColor StarColours[8]{QColor(120, 145, 165), QColor(65, 205, 115), QColor(140, 60, 50),
                                       QColor(215, 45, 45), QColor(20, 160, 205), QColor(160, 65, 215),
                                       QColor(255, 140, 200), QColor(150, 70, 95)};
